...
HD_PWD='/home/anzhelika/projekt/myIpv3/VivadoDesign/VivadoDesign.runs/Diagramm_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Diagramm_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Diagramm_rst_ps7_0_50M_0.tcl
