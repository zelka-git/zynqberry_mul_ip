...
HD_PWD='/home/anzhelika/projekt/myIpv3/VivadoDesign/VivadoDesign.runs/Diagramm_my_ip_v3_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Diagramm_my_ip_v3_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Diagramm_my_ip_v3_0_0.tcl
