...
HD_PWD='/home/anzhelika/projekt/myIpv3/VivadoDesign/VivadoDesign.runs/Diagramm_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Diagramm_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Diagramm_auto_pc_0.tcl
