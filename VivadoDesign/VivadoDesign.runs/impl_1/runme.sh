...
HD_PWD='/home/anzhelika/projekt/myIpv3/VivadoDesign/VivadoDesign.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Diagramm_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Diagramm_wrapper.tcl -notrace
