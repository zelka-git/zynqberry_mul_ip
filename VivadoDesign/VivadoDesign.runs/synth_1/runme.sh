...
HD_PWD='/home/anzhelika/projekt/myIpv3/VivadoDesign/VivadoDesign.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Diagramm_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Diagramm_wrapper.tcl
